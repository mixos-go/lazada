---
title: GetGlobalProductStatus
category: Cross Boarder Product API
api_name: GetGlobalProductStatus
method: GET
path: /product/global/status/get
---

**Category:** Cross Boarder Product API
**API:** GetGlobalProductStatus

**Method:** GET
**HTTP Path:** /product/global/status/get
