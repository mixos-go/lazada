---
title: SemiProductUpdate
category: Cross Boarder Product API
api_name: SemiProductUpdate
method: POST
path: /product/global/semi/update
---

**Category:** Cross Boarder Product API
**API:** SemiProductUpdate

**Method:** POST
**HTTP Path:** /product/global/semi/update
...
| data.product_id | Number | No | upgrade item id or global item id |
...
| 10002 |  |  | System error |
| 10003 |  |  | Item not found |
| 10004 |  |  | price need to be lower than the original price |
| 10005 |  |  | 商品已升级 |
| 10006 |  |  | 商品校验失败，无法升级 |
...
```json
{
  ...
  "children": [
    {
      ...
      "regexExpression": "",
      "constantValue": "",
      "desc": "upgrade item id or global item id "
    }
  ],
  "maxListSize": "",
  "id": 105856,
  ...
  "parentId": 105855,
  "dataSecurityLevel": "C2",
  "serviceParamPath": "com.alibaba.gsp.core.service.api.response.SemiProductUpgradeResponse",
  "mappingType": "1",
  "regexExpression": "",
  "constantValue": "",
  "desc": "response data"
