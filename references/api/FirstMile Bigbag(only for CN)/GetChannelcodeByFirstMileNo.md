---
title: GetChannelcodeByFirstMileNo
category: FirstMile Bigbag(only for CN)
api_name: GetChannelcodeByFirstMileNo
method: GET/POST
path: /logistics/cngfc/fulfill/getchannelcode
---

**Category:** FirstMile Bigbag(only for CN)
**API:** GetChannelcodeByFirstMileNo

**Method:** GET/POST
**HTTP Path:** /logistics/cngfc/fulfill/getchannelcode
...
| result.errorCode | String | Yes | errorCode |
| result.errorMsg | String | Yes | errorMsg |
...
```json
{
  ...
  "parentId": 0,
  "dataSecurityLevel": "C2",
  "serviceParamPath": "com.cainiao.cngfc.common.dto.GFCResultDTO",
  "mappingType": "1",
  "regexExpression": "",
  "constantValue": "",
  "desc": "result"
