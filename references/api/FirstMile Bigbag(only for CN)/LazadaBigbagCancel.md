---
title: LazadaBigbagCancel
category: FirstMile Bigbag(only for CN)
api_name: LazadaBigbagCancel
method: GET/POST
path: /logistics/cnpms/bigbag/cancel
---

**Category:** FirstMile Bigbag(only for CN)
**API:** LazadaBigbagCancel

**Method:** GET/POST
**HTTP Path:** /logistics/cnpms/bigbag/cancel
...
| result.data | Object | Yes | 取消结果 |
| result.success | Boolean | Yes | 是否成功，true:成功，false:失败 |
| result.error_code | String | Yes | 错误码 |
| result.error_msg | String | Yes | 错误描述 |
...
| P-088-0000-00-15-209 |  |  | handover content is not found |
