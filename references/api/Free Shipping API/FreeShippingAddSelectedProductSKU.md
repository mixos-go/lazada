---
title: FreeShippingAddSelectedProductSKU
category: Free Shipping API
api_name: FreeShippingAddSelectedProductSKU
method: POST
path: /promotion/freeshipping/product/sku/add
---

**Category:** Free Shipping API
**API:** FreeShippingAddSelectedProductSKU

**Method:** POST
**HTTP Path:** /promotion/freeshipping/product/sku/add
