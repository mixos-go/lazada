---
title: FreeShippingDeliveryOptionsQuery
category: Free Shipping API
api_name: FreeShippingDeliveryOptionsQuery
method: GET
path: /promotion/freeshipping/deliveryoptions/get
---

**Category:** Free Shipping API
**API:** FreeShippingDeliveryOptionsQuery

**Method:** GET
**HTTP Path:** /promotion/freeshipping/deliveryoptions/get
...
| data.name | String | Yes | delivery option name |
| data.value | String | Yes | delivery option value |
...
```json
{
  ...
  "parentId": 47019,
  "dataSecurityLevel": "C2",
  "serviceParamPath": "java.util.List<com.alibaba.global.merchant.promotion.lzd.domain.openapi.OpenApiKVDTO>",
  "mappingType": "1",
  "regexExpression": "",
  "constantValue": "",
  "desc": "response data"
