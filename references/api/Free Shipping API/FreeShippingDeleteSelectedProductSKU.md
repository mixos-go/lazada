---
title: FreeShippingDeleteSelectedProductSKU
category: Free Shipping API
api_name: FreeShippingDeleteSelectedProductSKU
method: POST
path: /promotion/freeshipping/product/sku/remove
---

**Category:** Free Shipping API
**API:** FreeShippingDeleteSelectedProductSKU

**Method:** POST
**HTTP Path:** /promotion/freeshipping/product/sku/remove
