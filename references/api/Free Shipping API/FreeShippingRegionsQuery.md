---
title: FreeShippingRegionsQuery
category: Free Shipping API
api_name: FreeShippingRegionsQuery
method: GET
path: /promotion/freeshipping/regions/get
---

**Category:** Free Shipping API
**API:** FreeShippingRegionsQuery

**Method:** GET
**HTTP Path:** /promotion/freeshipping/regions/get
...
| data.name | String | Yes | region name |
| data.value | String | Yes | region value |
