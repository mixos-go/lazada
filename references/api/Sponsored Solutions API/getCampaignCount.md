---
title: getCampaignCount
category: Sponsored Solutions API
api_name: getCampaignCount
method: GET/POST
path: /sponsor/solutions/campaign/getCampaignCount
---

**Category:** Sponsored Solutions API
**API:** getCampaignCount

**Method:** GET/POST
**HTTP Path:** /sponsor/solutions/campaign/getCampaignCount
...
```json
{
  ...
  "regexExpression": "",
  "constantValue": "",
  "desc": "The detail result, for this api is campaign count."
}
{
  "serviceParamHttpType": "",
  "serviceParamType": "1",
