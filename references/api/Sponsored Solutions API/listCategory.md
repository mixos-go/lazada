...
**Method:** GET/POST
**HTTP Path:** /sponsor/solutions/category/listCategory
...
| --- | --- | --- | --- |
| result | Object[] | Yes | - |
| result.label | String | No | The category name. |
| result.value | Number | No | The category id. |
| result.isLeaf | Boolean | No | Is the category leaf node. |
| result.selectable | Boolean | No | Can the category be selected. |
...
```json
{
  ...
  "children": [
    ...
    },
    {
      ...
      "regexExpression": "",
      "constantValue": "",
      "desc": "Is the category leaf node."
    },
    {
      "serviceParamHttpType": "",
      "serviceParamType": "1",
      ...
      "regexExpression": "",
      "constantValue": "",
      "desc": "Can the category be selected."
    }
  ],
  "maxListSize": "",
  "id": 90122,
  ...
  "parentId": 90121,
  "dataSecurityLevel": "C2",
  "serviceParamPath": "java.util.List<com.lazada.ad.bp.scenaro.dto.category.CategoryHSFResp>",
  "mappingType": "1",
  "regexExpression": "",
  "constantValue": "",
  "desc": "-"
