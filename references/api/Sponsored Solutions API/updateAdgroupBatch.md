---
title: updateAdgroupBatch
category: Sponsored Solutions API
api_name: updateAdgroupBatch
method: GET/POST
path: /sponsor/solutions/adgroup/updateAdgroupBatch
---

**Category:** Sponsored Solutions API
**API:** updateAdgroupBatch

**Method:** GET/POST
**HTTP Path:** /sponsor/solutions/adgroup/updateAdgroupBatch
...
| adgroupViewDTOList.adgroupId | Number | Yes | Adgroup id. |
| adgroupViewDTOList.switchStatus | String | Yes | Is the adgroup online rightnow.1:ON:0:OFF. |
