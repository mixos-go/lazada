---
title: SellerVoucheDeleteSelectedProductSKU
category: Seller Voucher API
api_name: SellerVoucheDeleteSelectedProductSKU
method: POST
path: /promotion/voucher/product/sku/remove
---

**Category:** Seller Voucher API
**API:** SellerVoucheDeleteSelectedProductSKU

**Method:** POST
**HTTP Path:** /promotion/voucher/product/sku/remove
