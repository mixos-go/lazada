---
title: changeProductBackground
category: Content API
api_name: changeProductBackground
method: POST
path: /content/ai/changeProductBackground
---

**Category:** Content API
**API:** changeProductBackground

**Method:** POST
**HTTP Path:** /content/ai/changeProductBackground
...
| result.task_id | String | Yes | task_id |
