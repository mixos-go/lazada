...
**Method:** GET
**HTTP Path:** /content/ai/getTaskStatus
...
| result.fail_message | String | Yes | fail message |
| result.status | String | Yes | task status |
