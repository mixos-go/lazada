---
title: SetInvoiceNumber
category: Order API
api_name: SetInvoiceNumber
method: POST
path: /order/invoice_number/set
---

**Category:** Order API
**API:** SetInvoiceNumber

**Method:** POST
**HTTP Path:** /order/invoice_number/set
...
| data.order_item_id | Number | No | Identifier of the order item. |
| data.invoice_number | String | No | The invoice number. |
...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| 20 |  |  | "E020: 59871357123 Invalid Order Item ID" |
  ...
  "children": [
    {
      ...
      "regexExpression": "",
      "constantValue": "",
      "desc": "Identifier of the order item."
    },
    {
      "serviceParamHttpType": "",
      "serviceParamType": "1",
      ...
      "sensitiveDataTag": "",
      "maskField": "",
      "serviceParamName": "invoice_number",
      "parentId": 116335,
      "dataSecurityLevel": "C2",
      "serviceParamPath": "java.until.String",
      "mappingType": "1",
      "regexExpression": "",
      "constantValue": "",
