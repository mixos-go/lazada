---
title: EstimateShippingFee
category: Lazada Logistics API
api_name: EstimateShippingFee
method: GET/POST
path: /logistics/epis/estimate_shipping_fee
---

**Category:** Lazada Logistics API
**API:** EstimateShippingFee

**Method:** GET/POST
**HTTP Path:** /logistics/epis/estimate_shipping_fee
...
| chargeFactor.packageType | String | No | Default package type = Sales_order. Enum [Sales_order, Customer_return] |
| chargeFactor.deliveryOption | String | No | Default delivery service type = standard. Enum [standard, economy, point_to_point] |
| chargeFactor.fulfillmentMethod | String | No | Default fulfillment method = Dropshipping. Enum [Dropshipping, MP, Marketplace] |
| chargeFactor.paymentType | String | Yes | Payment type. Enum [COD, NON-COD] |
| chargeFactor.weight | String | Yes | Weight. Unit: gram |
| chargeFactor.insuranceAmount | String | No | Insurance amount |
...
| data.transactionId | String | No | Expense item ID |
| data.transactionType | String | No | Expense item type example: Delivery, International Delivery, COD, Insurance, Surcharge |
| data.transactionName | String | No | Expense item name |
| data.amount | String | No | Fee amount |
| data.taxAmount | String | No | Tax amount |
| data.currency | String | No | Currency: IDR, MYR, PHP, SGD, THB, VND |
...
}
{
  ...
  "children": [
    ...
    },
    {
      ...
      "regexExpression": "",
      "constantValue": "",
      "desc": "Expense item type example: Delivery, International Delivery, COD, Insurance, Surcharge"
    },
    {
      "serviceParamHttpType": "",
      "serviceParamType": "1",
      ...
      "sensitiveDataTag": "",
      "maskField": "",
      "serviceParamName": "transactionName",
      "parentId": 114278,
      "dataSecurityLevel": "C2",
      "serviceParamPath": "java.lang.String",
      "mappingType": "1",
    ...
    },
    {
      ...
      "regexExpression": "",
      "constantValue": "",
      "desc": "Currency: IDR, MYR, PHP, SGD, THB, VND"
    }
  ],
  "maxListSize": "",
  "id": 114278,
  ...
  "parentId": 114275,
  "dataSecurityLevel": "C2",
  "serviceParamPath": "java.util.List<com.alibaba.logistics.epis.api.response.RatingResponse>",
  "mappingType": "1",
  "regexExpression": "",
  "constantValue": "",
  "desc": "Rating response"
}
{
  "serviceParamHttpType": "",
  "serviceParamType": "1",
