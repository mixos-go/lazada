---
title: EpisUploadAwbFulfillment
category: Lazada Logistics API
api_name: EpisUploadAwbFulfillment
method: POST
path: /logistics/epis/fulfillment/upload_awb
---

**Category:** Lazada Logistics API
**API:** EpisUploadAwbFulfillment

**Method:** POST
**HTTP Path:** /logistics/epis/fulfillment/upload_awb
