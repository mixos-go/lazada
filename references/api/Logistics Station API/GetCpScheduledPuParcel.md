---
title: GetCpScheduledPuParcel
category: Logistics Station API
api_name: GetCpScheduledPuParcel
method: GET
path: /logistics/station/v1/cp/scheduled-pu-parcels/list
---

**Category:** Logistics Station API
**API:** GetCpScheduledPuParcel

**Method:** GET
**HTTP Path:** /logistics/station/v1/cp/scheduled-pu-parcels/list
...
| data.dispatchedAt | Number | No | Runsheet is dispatched for courier pickup timestamp in milliseconds |
...
}
{
  ...
  "children": [
    ...
    },
    {
      ...
      "regexExpression": "",
      "constantValue": "",
      "desc": "Runsheet is dispatched for courier pickup timestamp in milliseconds"
    }
  ],
  "maxListSize": "",
  "id": 98404,
  ...
  "parentId": 98402,
  "dataSecurityLevel": "C2",
  "serviceParamPath": "com.alibaba.logistics.station.hsf.dto.openapi.OApiScheduledPuParcelResponse",
  "mappingType": "1",
  "regexExpression": "",
  "constantValue": "",
  "desc": "Response data"
