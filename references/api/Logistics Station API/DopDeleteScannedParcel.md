---
title: DopDeleteScannedParcel
category: Logistics Station API
api_name: DopDeleteScannedParcel
method: POST
path: /logistics/station/dop/scanned-parcels/delete
---

**Category:** Logistics Station API
**API:** DopDeleteScannedParcel

**Method:** POST
**HTTP Path:** /logistics/station/dop/scanned-parcels/delete
...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| PARCEL_NOT_FOUND |  |  | Parcel not found: {trackingNumber1,trackingNumber2} |
