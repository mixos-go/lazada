---
title: SearchCustomerReturnParcel
category: Logistics Station API
api_name: SearchCustomerReturnParcel
method: GET
path: /logistics/station/v1/dop/cr-parcels/search
---

**Category:** Logistics Station API
**API:** SearchCustomerReturnParcel

**Method:** GET
**HTTP Path:** /logistics/station/v1/dop/cr-parcels/search
...
| data.trackingNumber | String | No | Tracking number of parcel |
| data.maskedCustomerName | String | No | The masked customer name. For example: customer name "John Wick" will be masked to "J****Wick" |
...
}
{
  ...
  "children": [
    ...
    },
    {
      ...
      "sensitiveDataTag": "",
      "maskField": "",
      "serviceParamName": "maskedCustomerName",
      "parentId": 98456,
      "dataSecurityLevel": "C2",
      "serviceParamPath": "java.lang.String",
      "mappingType": "1",
      "regexExpression": "",
      "constantValue": "",
      "desc": "The masked customer name. For example: customer name \"John Wick\" will be masked to \"J****Wick\""
    }
  ],
  "maxListSize": "",
  "id": 98456,
  ...
  "parentId": 98454,
  "dataSecurityLevel": "C2",
  "serviceParamPath": "com.alibaba.logistics.station.hsf.dto.openapi.OApiDopCrParcelResponse",
  "mappingType": "1",
  "regexExpression": "",
  "constantValue": "",
  "desc": "Response data"
