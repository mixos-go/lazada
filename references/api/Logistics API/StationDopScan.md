---
title: StationDopScan
category: Logistics API
api_name: StationDopScan
method: GET/POST
...
| data | Object | No | test |
| data.trackingNumber | String | No | test |
| error | Object | No | test |
| error.errorCode | String | No | test |
...
}
{
  ...
  "parentId": 0,
  "dataSecurityLevel": "C2",
  "serviceParamPath": "com.alibaba.logistics.station.hsf.dto.autobox.dop.ScanParcelResponse",
  "mappingType": "1",
  "regexExpression": "",
  "constantValue": "",
  "desc": "test"
}
{
  ...
  "parentId": 0,
  "dataSecurityLevel": "C2",
  "serviceParamPath": "com.alibaba.logistics.shared.model.result.ErrorContext",
  "mappingType": "1",
  "regexExpression": "",
  "constantValue": "",
  "desc": "test"
