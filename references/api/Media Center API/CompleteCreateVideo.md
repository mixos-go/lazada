---
title: CompleteCreateVideo
category: Media Center API
api_name: CompleteCreateVideo
method: POST
path: /media/video/block/commit
---

**Category:** Media Center API
**API:** CompleteCreateVideo

**Method:** POST
**HTTP Path:** /media/video/block/commit
...
| FAIL_TO_BLOCK_COMPLETE |  |  | detail message |
| FAIL_TO_VALIDATE |  |  | detail message |
| FAIL_TO_ADD_VIDEO |  |  | detail message |
...
}
{
  ...
  "regexExpression": "",
  "constantValue": "",
  "desc": "return video_id for further call"
}
{
  "serviceParamHttpType": "",
  "serviceParamType": "1",
