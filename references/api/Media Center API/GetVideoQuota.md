...
**Method:** GET
**HTTP Path:** /media/video/quota/get
...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| ILLEGAL_PARAMETER |  |  | more detail |
| FAIL_TO_GET_SHOP_INFO |  |  | more detail |
| FAIL_TO_GET_USER_CAPACITY |  |  | more detail |
...
```json
{
  ...
  "regexExpression": "",
  "constantValue": "",
  "desc": "the max space of all video files"
}
{
  "serviceParamHttpType": "",
  "serviceParamType": "1",
