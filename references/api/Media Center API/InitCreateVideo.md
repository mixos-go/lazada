---
title: InitCreateVideo
category: Media Center API
api_name: InitCreateVideo
method: POST
...
**Method:** POST
**HTTP Path:** /media/video/block/create
...
| FAIL_TO_BLOCK_INIT |  |  | detail message |
...
```json
{
  ...
  "regexExpression": "",
  "constantValue": "",
  "desc": "return upload_id for further operation "
}
{
  "serviceParamHttpType": "",
  "serviceParamType": "1",
