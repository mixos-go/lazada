---
title: InuranceNotifyLapse
category: Lazada DG API
api_name: InuranceNotifyLapse
method: GET/POST
path: /digital/insurance/notificationlapse
---

**Category:** Lazada DG API
**API:** InuranceNotifyLapse

**Method:** GET/POST
**HTTP Path:** /digital/insurance/notificationlapse
