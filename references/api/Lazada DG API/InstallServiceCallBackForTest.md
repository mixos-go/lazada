---
title: InstallServiceCallBackForTest
category: Lazada DG API
api_name: InstallServiceCallBackForTest
method: GET/POST
path: /digital/install/test/servicecallback
---

**Category:** Lazada DG API
**API:** InstallServiceCallBackForTest

**Method:** GET/POST
**HTTP Path:** /digital/install/test/servicecallback
