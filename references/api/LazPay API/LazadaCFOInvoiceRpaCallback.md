---
title: LazadaCFOInvoiceRpaCallback
category: LazPay API
api_name: LazadaCFOInvoiceRpaCallback
method: GET/POST
path: /rpa/id/tax/callback
---

**Category:** LazPay API
**API:** LazadaCFOInvoiceRpaCallback

**Method:** GET/POST
**HTTP Path:** /rpa/id/tax/callback
