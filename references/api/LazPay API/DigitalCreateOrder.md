---
title: DigitalCreateOrder
category: LazPay API
api_name: DigitalCreateOrder
method: GET/POST
path: /digital/order/create
---

**Category:** LazPay API
**API:** DigitalCreateOrder

**Method:** GET/POST
**HTTP Path:** /digital/order/create
...
```json
{
  ...
  "regexExpression": "",
  "constantValue": "",
  "desc": "Third party's transactionId."
}
{
  "serviceParamHttpType": "",
  "serviceParamType": "1",
...
}
{
  ...
  "regexExpression": "",
  "constantValue": "",
  "desc": "Lazada's tradeOrderLine id."
}
{
  "serviceParamHttpType": "",
  "serviceParamType": "1",
