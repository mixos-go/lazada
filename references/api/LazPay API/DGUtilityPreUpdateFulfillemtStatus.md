---
title: DGUtilityPreUpdateFulfillemtStatus
category: LazPay API
api_name: DGUtilityPreUpdateFulfillemtStatus
method: GET/POST
path: /digital/service/updateFulfillemtStatus
---

**Category:** LazPay API
**API:** DGUtilityPreUpdateFulfillemtStatus

**Method:** GET/POST
**HTTP Path:** /digital/service/updateFulfillemtStatus
