---
title: GetIcpOrderFile
category: FBL API
api_name: GetIcpOrderFile
method: GET
...
| data.url | String | No | Pdf file download url |
...
}
{
  ...
  "maxSize": "",
  "paramName": "data",
  "demo": "{\"url\":\"http://test.misc.oss-ap-southeast-1.aliyuncs.com/testFile\"}",
  "required": false,
  "paramType": "4",
  "mappingValue": "",
  "minValue": null,
  ...
  "children": [
    {
      ...
      "maxSize": "",
      "paramName": "url",
      "demo": "http://test.misc.oss-ap-southeast-1.aliyuncs.com/testFile",
      "required": false,
      "paramType": "1",
      "mappingValue": "",
      "minValue": null,
