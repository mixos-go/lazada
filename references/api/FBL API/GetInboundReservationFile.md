---
title: GetInboundReservationFile
category: FBL API
api_name: GetInboundReservationFile
method: GET
path: /fbl/inbound_reservation/file
---

**Category:** FBL API
**API:** GetInboundReservationFile

**Method:** GET
**HTTP Path:** /fbl/inbound_reservation/file
  ...
  "children": [
    {
      ...
      "maxSize": "",
      "paramName": "url",
      "demo": "http://ascp-misc.oss-ap-southeast-1.aliyuncs.com/PrintOrder-RSO21112301269003.pdf?Expires=1638440526&OSSAccessKeyId=LTAIZijMnAjgMx5t&Signature=YCr5z1RaO0y9iavzMegFSp4eqf4%3D",
      "required": false,
      "paramType": "1",
      "mappingValue": "",
      "minValue": null,
