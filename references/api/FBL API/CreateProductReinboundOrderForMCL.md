---
title: CreateProductReinboundOrderForMCL
category: FBL API
api_name: CreateProductReinboundOrderForMCL
method: POST
path: /fbl/product_reinbound/create
---

**Category:** FBL API
**API:** CreateProductReinboundOrderForMCL

**Method:** POST
**HTTP Path:** /fbl/product_reinbound/create
