...
| skus.fulfillment_sku_id | String | Yes | fulfillment sku id |
| skus.store_code | String | Yes | warehouse code |
| skus.ratio | Number | Yes | ratio |
| skus.auto_balancing | Boolean | Yes | enable auto-balancing between channels |
