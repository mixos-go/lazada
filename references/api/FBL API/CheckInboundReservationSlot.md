---
title: CheckInboundReservationSlot
category: FBL API
api_name: CheckInboundReservationSlot
method: GET
path: /fbl/inbound_reservation/check
---

**Category:** FBL API
**API:** CheckInboundReservationSlot

**Method:** GET
**HTTP Path:** /fbl/inbound_reservation/check
...
| data | Object | No | data |
| data.slots | String[] | No | data slot list |
  ...
  "children": [
    {
      ...
      "maxSize": "",
      "paramName": "slots",
      "demo": "[\"2021-12-01T00:30:00Z\", \"2021-12-01T01:00:00Z\"]",
      "required": false,
      "paramType": "6",
      "mappingValue": "",
      "minValue": null,
