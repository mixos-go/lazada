---
title: DeleteFlexiComboProducts
category: Flexicombo API
api_name: DeleteFlexiComboProducts
method: POST
path: /promotion/flexicombo/products/delete
---

**Category:** Flexicombo API
**API:** DeleteFlexiComboProducts

**Method:** POST
**HTTP Path:** /promotion/flexicombo/products/delete
...
| 23 |  |  | E023: remove sku from flexi combo failed |
