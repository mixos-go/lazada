---
title: ConfirmDeliveryForDBS
category: Fulfillment API
api_name: ConfirmDeliveryForDBS
method: POST
path: /order/package/sof/delivered
---

**Category:** Fulfillment API
**API:** ConfirmDeliveryForDBS

**Method:** POST
**HTTP Path:** /order/package/sof/delivered
...
| dbsDeliveryReq.packages | Object[] | Yes | Batch size is limited to 20 |
| dbsDeliveryReq.packages.package_id | String | Yes | packageId |
  ...
  "children": [
    {
      ...
      "children": [
        {
          ...
          "parentId": 72095,
          "dataSecurityLevel": "C2",
          "serviceParamPath": "java.util.List<com.alibaba.global.seller.fulfill.api.model.openapi.DBSDeliveryResult>",
          "mappingType": "1",
          "regexExpression": "",
          "constantValue": "",
          "desc": "packages"
      ...
      "parentId": 72094,
      "dataSecurityLevel": "C2",
      "serviceParamPath": "com.alibaba.global.seller.fulfill.api.response.openapi.DBSDeliveryResp",
      "mappingType": "1",
      "regexExpression": "",
      "constantValue": "",
      "desc": "resp body"
