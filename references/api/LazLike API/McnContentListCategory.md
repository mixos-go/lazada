---
title: McnContentListCategory
category: LazLike API
api_name: McnContentListCategory
method: GET
path: /content/mcn/category/list
---

**Category:** LazLike API
**API:** McnContentListCategory

**Method:** GET
**HTTP Path:** /content/mcn/category/list
...
| result.categoryList | Object[] | Yes | the URL address of the uploaded image. |
  ...
  "children": [
    {
      ...
      "sensitiveDataTag": "",
      "maskField": "",
      "serviceParamName": "categoryList",
      "parentId": 91549,
      "dataSecurityLevel": "C2",
      "serviceParamPath": "com.lazada.lazlike.openapi.response.McnContentCategoryDTO",
      "mappingType": "1",
      "regexExpression": "",
      "constantValue": "",
