---
title: McnContentCompleteCreateVideo
category: LazLike API
api_name: McnContentCompleteCreateVideo
method: POST
path: /content/mcn/video/block/commit
---

**Category:** LazLike API
**API:** McnContentCompleteCreateVideo

**Method:** POST
**HTTP Path:** /content/mcn/video/block/commit
...
| result.videoId | Number | Yes | return video's id for further call |
  ...
  "children": [
    {
      ...
      "regexExpression": "",
      "constantValue": "",
      "desc": "return video's id for further call"
    },
    {
      "serviceParamHttpType": "",
      "serviceParamType": "1",
