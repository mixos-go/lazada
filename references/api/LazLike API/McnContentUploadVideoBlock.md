---
title: McnContentUploadVideoBlock
category: LazLike API
api_name: McnContentUploadVideoBlock
method: POST
path: /content/mcn/video/block/upload
---

**Category:** LazLike API
**API:** McnContentUploadVideoBlock

**Method:** POST
**HTTP Path:** /content/mcn/video/block/upload
...
| result.eTag | String | Yes | return e_tag for using in commit operation |
  ...
  "children": [
    {
      ...
      "regexExpression": "",
      "constantValue": "",
      "desc": "return e_tag for using in commit operation"
    },
    {
      "serviceParamHttpType": "",
      "serviceParamType": "1",
