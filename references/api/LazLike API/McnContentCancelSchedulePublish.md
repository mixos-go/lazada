---
title: McnContentCancelSchedulePublish
category: LazLike API
api_name: McnContentCancelSchedulePublish
method: POST
path: /content/mcn/content/cancelScheduled
---

**Category:** LazLike API
**API:** McnContentCancelSchedulePublish

**Method:** POST
**HTTP Path:** /content/mcn/content/cancelScheduled
...
| api_result.errorMessage | String | No | error code provided when the operation fails |
| api_result.errorCode | Number | No | error message provided when the operation fails |
