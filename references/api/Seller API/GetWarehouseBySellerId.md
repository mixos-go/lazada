---
title: GetWarehouseBySellerId
category: Seller API
api_name: GetWarehouseBySellerId
method: GET/POST
path: /rc/warehouse/get
---

**Category:** Seller API
**API:** GetWarehouseBySellerId

**Method:** GET/POST
**HTTP Path:** /rc/warehouse/get
...
| result.success | Object | Yes | xxx |
| result.module | Object | Yes | result |
...
```json
{
  ...
  "children": [
    ...
    },
    {
      ...
      "parentId": 58742,
      "dataSecurityLevel": "C2",
      "serviceParamPath": "com.alibaba.global.supplychain.rc.api.dto.response.WarehouseInfoOpenApiDTO",
      "mappingType": "1",
      "regexExpression": "",
      "constantValue": "",
      "desc": "result"
