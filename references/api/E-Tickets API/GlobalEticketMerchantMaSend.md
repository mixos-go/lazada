---
title: GlobalEticketMerchantMaSend
category: E-Tickets API
api_name: GlobalEticketMerchantMaSend
method: GET/POST
path: /eticket/ma/send
---

**Category:** E-Tickets API
**API:** GlobalEticketMerchantMaSend

**Method:** GET/POST
**HTTP Path:** /eticket/ma/send
...
| isv_ma_list.code | String | Yes | code |
| isv_ma_list.num | Number | Yes | available num |
